...
const PUBLISHABLE_KEY = import.meta.env.VITE_STRIPE_PUBLIC_KEY; // Put your Stripe publishable key here
const SECRET_KEY = process.env.STRIPE_SECRET_KEY;     // Put your Stripe secret key here (INSECURE!)
